...
public class DateHelper extends DateUtils {
    ...
    public static String getBeforeTime(int min) {
        ...
        String beforeT = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss").format(beforeD);  // 前多少分钟
        return beforeT;
    }


    public static long pastMinutes(String stm, String etm) {
        try {
            ...
            Date sdate = start.parse(stm);
            Date edate = start.parse(etm);
 ...
 /*   public static void main(String args[]) {
        getBeforeTime(5);
        String stm="2019-03-13 13:15:00";
        String etm="2019-03-14 13:15:00";
        long t=pastMinutes(stm,etm);
    }*/
